...
public class RemengeshouController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,RemengeshouEntity remengeshou, 
		HttpServletRequest request){
        EntityWrapper<RemengeshouEntity> ew = new EntityWrapper<RemengeshouEntity>();
		PageUtils page = remengeshouService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, remengeshou), params), params));
        return R.ok().put("data", page);
    ...
    public R info(@PathVariable("id") Long id){
		...
		remengeshou.setClicktime(new Date());
		remengeshouService.updateById(remengeshou);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,RemengeshouEntity remengeshou, HttpServletRequest request,String pre){
        EntityWrapper<RemengeshouEntity> ew = new EntityWrapper<RemengeshouEntity>();
