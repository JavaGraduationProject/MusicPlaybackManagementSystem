<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="歌手分类" prop="geshoufenlei">
          <el-select :disabled="ro.geshoufenlei" v-model="ruleForm.geshoufenlei" placeholder="请选择歌手分类">
            <el-option
                v-for="(item,index) in geshoufenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="歌手分类" prop="geshoufenlei">
	      <el-input v-model="ruleForm.geshoufenlei"
                placeholder="歌手分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="代表作" prop="daibiaozuo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="代表作"
                  v-model="ruleForm.daibiaozuo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.daibiaozuo" label="代表作" prop="daibiaozuo">
                    <span>{{ruleForm.daibiaozuo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.touxiang = true;
          ...
          if(o=='geshoufenlei'){
            this.ruleForm.geshoufenlei = obj[o];
	    this.ro.geshoufenlei = true;
            continue;
          }
          if(o=='gequliupai'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/geshoufenlei/geshoufenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.geshoufenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.geshoujieshao = this.ruleForm.geshoujieshao.replace(reg,'../../../springbootl7d22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
