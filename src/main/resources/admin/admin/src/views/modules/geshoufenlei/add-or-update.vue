<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="歌手分类" prop="geshoufenlei">
          <el-input v-model="ruleForm.geshoufenlei" 
              placeholder="歌手分类" clearable  :readonly="ro.geshoufenlei"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `geshoufenlei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.geshoufenleiCrossAddOrUpdateFlag = false;
						 this.parent.search();
