<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.gequyinpin" label="歌曲音频" prop="gequyinpin">
          <file-upload
          tip="点击上传歌曲音频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.gequyinpin?ruleForm.gequyinpin:''"
          @change="gequyinpinUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.gequyinpin" label="歌曲音频" prop="gequyinpin">
            <el-button type="text" size="small" @click="download(ruleForm.gequyinpin)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="歌曲详情" prop="gequxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gequxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gequxiangqing" label="歌曲详情" prop="gequxiangqing">
                    <span v-html="ruleForm.gequxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yinlefenlei = true;
          ...
          if(o=='gequyinpin'){
            this.ruleForm.gequyinpin = obj[o];
	    this.ro.gequyinpin = true;
            continue;
          }
          if(o=='geshou'){
	    ...
	    this.ro.biaoqian = true;
          ...
          if(o=='gequxiangqing'){
            this.ruleForm.gequxiangqing = obj[o];
	    this.ro.gequxiangqing = true;
            continue;
          }
          if(o=='faxingriqi'){
	...
	this.ruleForm.gequxiangqing = this.ruleForm.gequxiangqing.replace(reg,'../../../springbootl7d22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.gequyinpin!=null) {
		this.ruleForm.gequyinpin = this.ruleForm.gequyinpin.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    gequyinpinUploadChange(fileUrls) {
	this.ruleForm.gequyinpin = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
